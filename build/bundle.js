...
var _mockServer = __webpack_require__(15);
...
$search.on('keyup', function (e) {
  ...
  // fixed .2
  if (lastTimeout) {
    _window.window.clearTimeout(lastQuery);
  }

  var queryId = ++nextQueryId;

  lastTimeout = _window.window.setTimeout(function () {
...
function getItems(search) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    window.setTimeout(function () {
      resolve([search, 'Item 2', 'Item random ' + Math.random(), 'Item 2 random ' + Math.random()]);
    }, 500 + Math.random() * 500);
  });
}
